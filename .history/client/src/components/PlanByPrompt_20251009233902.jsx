 ...
 const userData = JSON.parse(localStorage.getItem("user-info"));
  ...
  const {activeTab, setActiveTab,
    manualRoute,origin,
       events,setEvents,
        ...
        destination,
        setDestination,
        setManualRoute,manualWeather,setManualWeather,AIResult,setAIResult,itinerary,setItinerary,tabId}=useTrip();
  const generate = async () => {
    ...
    try {
      ...
      console.log("data",data.finalResponse.content);
  ...
  routes: data.trip.route// entire object returned from backend
      ...
      setAIResult(data.finalResponse.content);
    } catch (err) {
