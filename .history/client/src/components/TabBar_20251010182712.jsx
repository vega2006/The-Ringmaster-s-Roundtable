...
export default function RightSidebar() {
  ...
  return (
    <aside className="bg-sky-50 border-l border-sky-200 py-6 px-2 w-60 flex-shrink-0 flex flex-col shadow-sm">
      <h2 className="text-xl font-semibold mb-4 text-sky-700 flex items-center justify-center">
        🗂 Your Tabs
      </h2>
        ...
        {tabs.map((tab) => (
          ...
          >
            <button
              ...
              className="flex-1 text-left font-medium text-sky-800 truncate group-hover:text-sky-900"
            >
              {tab.name}
            </button>
