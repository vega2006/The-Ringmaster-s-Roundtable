...
export default function PlanByPrompt() {
  ...
  const {activeTab, setActiveTab,manualRoute,
        setManualRoute,manualWeather,setManualWeather,AIResult,setAIResult}=useTrip();
  const generate = async () => {
    ...
    try {
      ...
      console.log(data.finalResponse.kwargs.content);
      setManualWeather(data.weather);
      setManualRoute(data.route);
      setActiveTab("Weather");
      setAIResult(data.finalResponse.kwargs.content);
    } catch (err) {
