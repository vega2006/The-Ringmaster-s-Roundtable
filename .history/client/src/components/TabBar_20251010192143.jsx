...
export default function RightSidebar() {
  ...
  return (
    <aside className="bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] border-l border-sky-700 py-6 px-3 w-64 flex-shrink-0 flex flex-col shadow-lg">
      {/* Header */}
      ...
      {/* Tabs List */}
      <div className="flex flex-col space-y-2 mb-4 overflow-y-auto max-h-[60vh] scrollbar-thin scrollbar-thumb-sky-600">
        {tabs.map((tab) => (
          <div
            key={tab.tabId}
