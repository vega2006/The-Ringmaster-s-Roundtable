    ...
    <div>
      ...
      <TripProvider>
        ...
        <div className="min-h-screen bg-gradient-to-br from-sky-100 via-white to-amber-100 font-inter">
          <AppHeader />
         <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[240px_1fr_240px] bg-white shadow-2xl rounded-2xl overflow-hidden mt-4 mb-8">
  <PromptBasedSidebar />  {/* Left Sidebar */}
  
  <MainContent>
    <AIContentRouter />
  </MainContent>        {/* Main content */}

  <RightSidebar userId={userInfo?.id} /> {/* Right Sidebar */}
</div>
