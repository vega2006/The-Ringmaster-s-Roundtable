...
`;
  ...
  console.log("decision.tool_calls",decision.tool_calls);
...
// 🗣️ Ask Gemini to generate the summary
...
// 📝 Store the summary as a string
trip.finalResponse = finalResponse.content || finalResponse.toString();
await trip.save();
