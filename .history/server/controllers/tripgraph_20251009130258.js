...
const { StateGraph, StateAnnotation, END, Command } = require("@langchain/langgraph");
const { getWeatherTool, getRouteTool, getItineraryTool, getEventTool } = require("./tool");

// Define state annotation
const TripState = new StateAnnotation({
  city: "string",
  travelDate: "string",
  startDate: "string",
  endDate: "string",
...
const graph = new StateGraph(TripState)
  ...
  .setEntryPoint("get_weather"); // Proper entrypoint
